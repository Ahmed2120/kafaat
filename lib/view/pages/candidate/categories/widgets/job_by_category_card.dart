...
class JobsByCategoryItem extends StatelessWidget {
  final OpenJobs job;
  final String categoryName;

  const JobsByCategoryItem({
    Key? key,
    required this.job,
        ...
        children: [
          Row(
            ...
            children: [
              ...
              // InkWell(
              //   onTap: () {
              //     // CandidateAppProvider.listenFalse(context)
              //     //     .addToWishlist(job.id!, retry: true);
              //   },
              //   child: Icon(job.wishlist != null
              //       ? Icons.bookmark
